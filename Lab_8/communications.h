...
#define startCounter Timer_A_startCounter
#define stopCounter Timer_A_stopCounter
#define configUp Timer_A_configureUpMode
...
#define setPeripheralOutput GPIO_setAsPeripheralModuleFunctionOutputPin
...
#define configMulti ADC14_configureMultiSequenceMode
